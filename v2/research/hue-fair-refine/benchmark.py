...
Uses the real JS transforms. COMBVD was fitted. No dropped-error suppression,
...
def main():
    ...
    assert (HERE/'results/gentle.json').read_bytes()==frozen_metric
    for gamut,n in [('srgb',3331),('full',3813)]:
