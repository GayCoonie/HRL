...
def main():
    ...
    for key,default,typ in [('name',None,str),('start','parent',str),('steps',700,int),('stride',2,int),('samples',97,int),('visual',.28,float),('fair',.6,float),('sheet',.08,float),('corner',1.,float),('guard',2.,float),('blue',.75,float),('layers',5,int),('mode','bilinear',str),('gridroot','../gen-tonal-fit/results',str)]:
