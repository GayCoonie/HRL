...
for gamut in ['srgb','full']:
 for tag,hues in [('all',[30,90,150,210,240,255,263,269,273,275,277,281,285,293,300,330]),('dark',[255,263,269,273,275,277,281,285,293])]:
  im=Image.new('RGB',(215*len(names)+10,260*len(hues)+50),'#21172c');d=ImageDraw.Draw(im);d.text((12,7),f'HRL balanced-parent refinement | {gamut} | same H/R/L, exact inverse; preview clipping labelled',font=font,fill='#83e8ca')
