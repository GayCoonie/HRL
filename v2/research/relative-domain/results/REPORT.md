...
**Clipped imports are marked †.** Missing strict results are N/A, not zero. The high-magnitude hue continuation is separately counted in the JSON audits. No overall rank is claimed for a clipped-input pipeline.
