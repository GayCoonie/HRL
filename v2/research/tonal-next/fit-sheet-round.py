...
import argparse,copy,json,time,hashlib,math,importlib.util,sys
import numpy as np
import torch
...
def main():
    ...
    parentpath=P/'trials/metric-b2.json';parent=json.loads(parentpath.read_text());startpath=parentpath if args.start=='parent' else P/f'trials/{args.start}.json';rec=json.loads(startpath.read_text())
