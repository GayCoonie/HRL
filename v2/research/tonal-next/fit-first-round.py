...
def main():
    ...
    def assess():
        ...
        for p in profiles:
            ...
            loss=st+args.unweighted*unweighted+args.visual*riskagg(risk)+args.sheet*riskagg(sheet)+args.corner*retreat+args.guard*guard+args.pathguard*regret+args.metricguard*metric_guard
            total=total+.5*loss
