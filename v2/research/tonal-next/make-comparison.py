...
note='This research candidate meets the declared smoothness and accuracy checks. Beta 1 remains the frozen default.' if eligible else 'No research candidate meets every declared improvement check. Beta 1 remains the default; the measured tradeoffs are available for inspection.'
