...
const names=['parent','smooth','C1-only','fit-2p0','fit-0p5'];
...
for(const name of names){
 ...
 out.models[name]={summary,ramps:axes};console.log(name,summary);fs.writeFileSync(new URL('results/visual-paths.json',import.meta.url),JSON.stringify(out,null,2)+'\n');
}
