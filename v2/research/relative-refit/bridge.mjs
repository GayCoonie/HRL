...
import {createInterface} from 'node:readline';import {createRelativeHRL} from '../relative-domain/index.mjs';import {createRelativeRefit} from './index.mjs';
...
const m=c.mode==='baseline'?await createRelativeHRL({...options,variant:'candidate'}):await createRelativeRefit({...options,checkpoint:c.checkpoint||'balanced'});
